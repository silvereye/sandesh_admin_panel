<%@ page language="java" import="java.util.*,mypack.*,java.text.*,dbutil.*,java.sql.*" pageEncoding="ISO-8859-1"%>
...
function showData()
	...
	var load="<table id='utable'  width='100%' class='style1 tablesorter' cellspacing='0'>";
	load+= " <tr >    <td width=''>&nbsp;</td> <td width='' style='text-align: center;'><img  src='/unifiedmail/images/myload.GIF'/></td>";
		load+="<td width=''>&nbsp;</td></tr>     </table>";
		document.getElementById("div1").innerHTML = load; 
...
xmlhttp.open("GET","/unifiedmail/global/userdetaildataexl.jsp?domain="+domain,true);
...
<div class="top-space5 bt-space5 left-space5">
    ...
    <input type="button" onclick="showData()" value="Get File" class="button" />
    ...
    <div id="div1">
     ...
     <table id="utable" style="display: none;" width="100%" class="style1 tablesorter" cellspacing="0">
     <tr >
     <td width="">&nbsp;</td>
