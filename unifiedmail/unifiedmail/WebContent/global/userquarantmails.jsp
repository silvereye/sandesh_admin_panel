...
<head>
    ...
    <title>Sent Mails | Silvereye Unified E-mail Server</title>
...
function qRel(mid, rid) {
  ...
  if(vall!=null && vall!="")
  {
  alertify.alert("Mail has been released.<br><br>");
  }
   
    	
    }
    }
    xmlhttp.open("GET","/unifiedmail/servlet/QRelServlet?mid="+mid+"&rid="+rid,true);
...
//alert(dt+" "+sel)
   ...
   var vall=xmlhttp.responseText;
    ...
    xmlhttp.open("GET","/unifiedmail/global/userquarantmailsdata.jsp?val="+v+"&id="+id+"&ml="+ml+"&cnt="+cnt,true);
   //var xx=document.f.chk.value;
   //alert(xx);
    xmlhttp.send();
...
<div class="content-box">
    <div class="box-body">
        <div class="box-header clear">
            ...
            <li ><a href="/unifiedmail/global/usersentmails.jsp?ml=<%=ml %>">Sent Mails</a></li>
          
      <li ><a href="/unifiedmail/global/userreceivedmails.jsp?ml=<%=ml %>">Received Mails</a></li>
      <li ><a href="/unifiedmail/global/userspamvirusmails.jsp?ml=<%=ml %>">Spam/Virus</a></li>       
      <li class="active"><a href="/unifiedmail/global/userquarantmails.jsp?ml=<%=ml %>">Quarantined Mails</a></li>
            ...
            <h2>
                        ...
                        Quarantined Mails of User: <%=ml %>
            <a href="/unifiedmail/global/edituserprofile.jsp?ml=<%=ml %>">
        ...
        <% String id=Crudoperation.getIdToMail(ml,"SELECT * FROM maddr where email=?");
        int mid=0;
        if(id!=null && !id.equals(""))
        {
        mid=Integer.parseInt(id);
        }
            	String sq="SELECT count(*) FROM msgs ms, msgrcpt mt where ms.mail_id=mt.mail_id and (ms.sid=? or mt.rid=?) and ms.quar_type=? ORDER BY time_num DESC";
     ...
     <td width="">&nbsp;</td></tr>
        ...
        <div class="tab-footer clear f1">
                ...
                <div class="fl">
                    ...
                    <input type="button" value="Print" onclick="printDiv()" class="button fl-space" />
                </div>
