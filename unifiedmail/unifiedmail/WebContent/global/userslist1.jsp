...
$(window).scroll(function(){
 ...
 document.getElementById("hidno").value=parseInt(no)+10;
      $.post("/unifiedmail/global/userlistdata.jsp?no="+no+"&dm="+dm, function(data) {
...
<li><a href="/unifiedmail/global/mailaliaseslist.jsp?dm=<%=dm %>">Mail Aliases</a></li>
  ...
  <input type="hidden" name="hid_dm" id="hid_dm" value="<%=dm %>" />
   <input type="hidden" name="hid_no" id="hidno" value="10" />
