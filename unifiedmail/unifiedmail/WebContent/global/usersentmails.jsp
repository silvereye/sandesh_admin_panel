...
//alert(dt+" "+sel)
   ...
   var vall=xmlhttp.responseText;
    ...
    xmlhttp.open("GET","/unifiedmail/global/usersentmailsdata.jsp?val="+v+"&id="+id+"&ml="+ml+"&cnt="+cnt,true);
...
<div class="content-box">
    <div class="box-body">
        <div class="box-header clear">
            ...
            <li class="active"><a href="/unifiedmail/global/usersentmails.jsp?ml=<%=ml %>">Sent Mails</a></li>
  ...
  <li ><a href="/unifiedmail/global/userspamvirusmails.jsp?ml=<%=ml %>">Spam/Virus</a></li>       
      <li ><a href="/unifiedmail/global/userquarantmails.jsp?ml=<%=ml %>">Quarantined Mails</a></li>
        ...
        mid=Integer.parseInt(id);
            	...
            	String sq="SELECT count(*) FROM msgs ms, msgrcpt mt where ms.mail_id=mt.mail_id and ms.sid=? and ms.content NOT IN (?, ?, ?) ORDER BY time_num DESC";
