    ...
    <table class="style1 tablesorter" cellspacing="0">
            ...
            <tbody>
         	...
         	String ml=request.getParameter("ml");
  			String sql="SELECT * FROM msgs ms, msgrcpt mt where ms.mail_id=mt.mail_id and (ms.sid=? or mt.rid=?) and ms.quar_type=? ORDER BY time_num DESC LIMIT ? , ?";
    ...
    /* 
       ...
       ctit="Spammy(tag2)";
         ...
         */       
                 %>
                    <tr> 
                       <td class="vcenter"><%=smail %></td>
                        <td class="vcenter"><%=rmail %></td>
                        <td class="vcenter"><%=sub %></td>
