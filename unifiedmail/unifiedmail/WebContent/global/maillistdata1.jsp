...
{
String base="ou=Groups,domainName="+arr_dm[i]+",o=domains,"+base1;//dc=springbirds,dc=co,dc=in";//"ou=Users,domainName="+arr_dm[i]+",o=domains"+(String)hs.getAttribute("base");
...
if(v3.indexOf("@")>0)
{
 ...
 %>
    ...
    <td width="126"><%=v1 %></td>
    <td width="300" align="left"><a href="/unifiedmail/global/editmaillistprofile.jsp?ml=<%=v3 %>"><%=v3 %></a></td>
