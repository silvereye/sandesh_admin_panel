    ...
    <div class="box-body">
        <div class="box-header clear">
                <ul class="tabs clear">
                       ...
                       <li class="active"><a href="/unifiedmail/global/throttlinguser.jsp?ml=<%=mail %>">Throttling</a></li>
        ...
        <div class="box-wrap clear">
           <form action="/unifiedmail/servlet/EditThrottlingUserServlet" name="f" method="post" onsubmit="return valData()">
      ...
      int outqid=Crudoperation_Policy.getQtID(outpid,"Sender:user@domain");
      int out_dis=1;
      int out_max=0;
      long out_time=0;
      int outqidlmt=0;
...
String innm=mail+" Inbound";
      ...
      int inqid=Crudoperation_Policy.getQtID(inpid,"Recipient:user@domain");
       int in_dis=1;
      int in_max=0;
      long in_time=0;
      int inqidlmt=0;
 ...
 %>
    ...
    <div class="form-field clear">
        ...
        <input type="radio" <%=i_cus %> name="in_time"  value="0" />Custom: 
