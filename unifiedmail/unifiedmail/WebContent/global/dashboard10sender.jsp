                                    ...
                                    %>
                                    	 ...
                                    	 <ul>
                                        	...
                                        	<%
                                        	 ...
                                        	 int div_flg=0;
   String dn=dstr;
  			String sql="SELECT * FROM msgs ms, msgrcpt mt where ms.mail_id=mt.mail_id and ( (select email from maddr where id=ms.sid ) like ?) and ms.content NOT IN (?, ?, ?) and  ( ms.time_iso like ?) ";
	...
	if(str==null)
		{
		str=""+rs.getInt("ms.sid");
		}
		else
		{
		str=str+","+rs.getInt("ms.sid");
		}
