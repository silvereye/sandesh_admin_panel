	  ...
	  else  if(perm=="del")
	  {
		  alertify.confirm("Do you want to Delete All selected Users<br><br>", function (e) {
				if (e) {
					...
					window.location="/unifiedmail/servlet/DelelteSelectedUserServlet?ml_val="+ml_val;
		 			//return true;
				} else {
					alertify.error("You've clicked Cancel");
					return false;
...
<li><a href="/unifiedmail/global/mailaliaseslist.jsp?dm=<%=dm %>">Mail Aliases</a></li>
   	...
   	<div class="clr"></div>
        ...
        <%
        int cnt=0;
        cnt=NoOfUser.uCount(url,username,password,base1,dm);
        cnt--;
         %>
     ...
     <div class="main-heading2" id="msg_suc"> Selected account has been <%=stt %>. <span class="close">	<a onclick="removeMsg('msg_suc')" title="click me to remove" style="cursor: pointer;">X</a>	</span>	</div>
      ...
      %>
                	...
                	<div class="row-one">
                      ...
                      <div class="iconic-btn">	<a href="/unifiedmail/global/userslistMaxQuota.jsp?dm=<%=dm %>">Quota Max used Users</a>	</div>
