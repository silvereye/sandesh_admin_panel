...
<head>
    ...
    <title>Edit Admin Profile | Silvereye Unified E-mail Server</title>
...
<body>
 <%@include file="header.jsp" %>
   ...
   if(utype!=null && (utype.equalsIgnoreCase("Admin") || utype.equalsIgnoreCase("LocalAdmin")))
   {
    %>
...
<div class="content-box">
    <div class="box-body">
        ...
        <div class="box-wrap clear">
           <form id="register" action="/unifiedmail/servlet/EditPasswordAdminProfileServlet" name="f" method="post" onsubmit="return valData()">
