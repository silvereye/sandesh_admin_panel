...
//alert(dt+" "+sel)
   ...
   var vall=xmlhttp.responseText;
    ...
    xmlhttp.open("GET","/unifiedmail/global/userspamvirusmailsdata.jsp?val="+v+"&id="+id+"&ml="+ml+"&cnt="+cnt,true);
...
<li ><a href="/unifiedmail/global/userreceivedmails.jsp?ml=<%=ml %>">Received Mails</a></li>
  <li class="active"><a href="/unifiedmail/global/userspamvirusmails.jsp?ml=<%=ml %>">Spam/Virus</a></li>       
      <li ><a href="/unifiedmail/global/userquarantmails.jsp?ml=<%=ml %>">Quarantined Mails</a></li>
        ...
        mid=Integer.parseInt(id);
            	...
            	String sq="SELECT count(*) FROM msgs ms, msgrcpt mt where ms.mail_id=mt.mail_id and (ms.sid=? or mt.rid=?) and ms.content NOT IN (?, ?, ?,?,?,?,?) ORDER BY time_num DESC";
