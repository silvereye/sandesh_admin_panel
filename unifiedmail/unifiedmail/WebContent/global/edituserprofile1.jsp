...
DirContext ctx=LDAPConnection.getConnection(url, base, username, password);
   ...
   Attribute atr = testAttributes.get("cn");
   cn =  atr.get().toString();
   
   atr = testAttributes.get("forcePasswordChange");
   fpc =  atr.get().toString();
   
   atr = testAttributes.get("sn");
   sn =  atr.get().toString();
   
   atr = testAttributes.get("initials");
   init =  atr.get().toString();
   
   atr = testAttributes.get("givenName");
   fn =  atr.get().toString();
   
   atr = testAttributes.get("accountStatus");
   acc =  atr.get().toString();
   
   atr = testAttributes.get("FTPStatus");
   ftp =  atr.get().toString();
   
   atr = testAttributes.get("memberOfGroup");
   list_maillist =  atr.get().toString();
   
   atr = testAttributes.get("enabledService");
   serv =  atr.get().toString();
   if(serv.contains("displayedInGlobalAddressBook"))
  	{
  	book=1;
  	}
   
   atr = testAttributes.get("mailQuota");
   String qstr =  atr.get().toString();
   if(qstr!=null)
   {
	   long lg=Long.parseLong(qstr);
   ...
   atr = testAttributes.get("FTPQuotaMBytes");
   String fstr =  atr.get().toString();
 if(fstr!=null)
 {
	 long lg=Long.parseLong(fstr);
     if((lg>=1024))
     {
        lg=(lg/1024);
     fquota=""+lg;
 ...
 atr = testAttributes.get("mobile");
 mob =  atr.get().toString();
 
 atr = testAttributes.get("telephoneNumber");
 tel =  atr.get().toString();
 
 atr = testAttributes.get("dateOfJoining");
 String jstr =  atr.get().toString();
 ...
 atr = testAttributes.get("dateOfBirth");
 String dstr =  atr.get().toString();
 ...
 atr = testAttributes.get("anniversary");
 String astr =  atr.get().toString();
 ...
 atr = testAttributes.get("homePhone");
 hmob =  atr.get().toString();
 
 atr = testAttributes.get("postalAddress");
 postadd =  atr.get().toString();
 
 atr = testAttributes.get("postalCode");
 postcode =  atr.get().toString();
 
 atr = testAttributes.get("preferredLanguage");
 plang =  atr.get().toString();
