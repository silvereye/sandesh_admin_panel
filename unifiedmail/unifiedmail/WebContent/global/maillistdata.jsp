...
<html>
  ...
  <body>
    ...
    <td width="183" align="left">Deliver Restriction</td>
    <td width="80" align="center">List Status</td>
  </tr>
    </thead>
    <%
...
for(int j=0;j<arr_dm.length;j++)
{
String base="ou=Groups,domainName="+arr_dm[j]+",o=domains,"+base1;//dc=springbirds,dc=co,dc=in";//"ou=Users,domainName="+arr_dm[i]+",o=domains"+(String)hs.getAttribute("base");
DirContext ctx=LDAPConnection.getConnection(url, base, username, password);
String v1="";
String v2="";
String v3="";
String v4="Unrestricted";
SearchControls constraints = new SearchControls(); 
constraints.setSearchScope(SearchControls.ONELEVEL_SCOPE);
String attrList[] = {"cn","accountStatus","mail","accessPolicy"}; 
...
if (attrs == null) {
    ...
    while (ae.hasMoreElements()) {
        ...
        {
        v4="Domain and sub-domain users";
        } 
        else if(str.equalsIgnoreCase("membersOnly"))
        {
        v4="Members";
        }
        else if(str.equalsIgnoreCase("allowedOnly"))
        {
        v4="Moderators";
        }
        else if(str.equalsIgnoreCase("membersAndModeratorsOnly"))
        {
        v4="Members and moderators";
        }
        else  
        {
        v4="Unrestricted";
...
//init=arr[1];
 ...
 v44=arr[3];
    ...
    <td  width="30" align="center"><label>
        <input type="checkbox" name="CheckboxGroup1" id="checkbox" value="<%=v33 %>"/>
    </label></td>

    <td width="126"><%=v11 %></td>
    <td width="300" align="left"><a href="/unifiedmail/global/editmaillistprofile.jsp?ml=<%=v33 %>"><%=v33 %></a></td>
    <td width="120" align="left"><%=v44 %></td>
    ...
    <td width="80" align="center"><table width="60%">
      <tr>
       ...
       <%} %>
      <td><a class="tooltips" id="<%=v33 %>"><img src="/unifiedmail/images/delete-icon.png"  name="<%=v33 %>" onclick="mydel_dom(this.name)"/>
