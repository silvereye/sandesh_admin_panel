    ...
    <table class="style1 tablesorter" cellspacing="0">
            ...
            <tbody>
         	...
         	String ml=request.getParameter("ml");
  			String sql="SELECT * FROM msgs ms, msgrcpt mt where ms.mail_id=mt.mail_id and mt.rid=? and ms.content NOT IN (?, ?, ?) ORDER BY time_num DESC LIMIT ? , ?";
