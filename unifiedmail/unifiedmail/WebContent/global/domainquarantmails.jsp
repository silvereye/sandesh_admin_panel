...
<head>
    ...
    <title>Received Mails under domain | Silvereye Unified E-mail Server</title>
...
//alert(dt+" "+sel)
   ...
   var vall=xmlhttp.responseText;
    ...
    xmlhttp.open("GET","/unifiedmail/global/domainquarantmailsdata.jsp?val="+v+"&dn="+dn+"&cnt="+cnt,true);
   //var xx=document.f.chk.value;
   //alert(xx);
    xmlhttp.send();
...
<div class="content-box">
    <div class="box-body">
        <div class="box-header clear">
            ...
            <li ><a href="/unifiedmail/global/domainsentmail.jsp?dn=<%=dn %>">Sent Mails</a></li>
...
<li ><a href="/unifiedmail/global/domainreceivedmails.jsp?dn=<%=dn %>">Received Mails</a></li>
  <li ><a href="/unifiedmail/global/domainspamvirusmails.jsp?dn=<%=dn %>">Spam/Virus</a></li>       
      <li class="active"><a href="/unifiedmail/global/domainquarantmails.jsp?dn=<%=dn %>">Quarantined Mails</a></li>
            ...
            <h2>
                        ...
                        Quarantined Mails of Domain: <%=dn %>
        ...
        <% 
            	String sq="SELECT count(*) FROM msgs ms, msgrcpt mt where ms.mail_id=mt.mail_id and (( (select email from maddr where id=mt.rid ) like ?) or ( (select email from maddr where id=ms.sid ) like ?)) and ms.quar_type=? ORDER BY time_num DESC";
