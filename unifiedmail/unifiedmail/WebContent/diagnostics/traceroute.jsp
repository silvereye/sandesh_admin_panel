...
<html>
  <head>
    ...
    <title>Traceroute | Silvereye Unified E-mail Server</title>
...
var e = document.getElementById("cnt");
 ...
 if (window.XMLHttpRequest)
   ...
   var vall=xmlhttp.responseText;
    ...
    xmlhttp.open("GET","/unifiedmail/servlet/TraceRouteServlet?ip="+ip+"&cnt="+cnt,true);
...
<div class="form-field clear">
            ...
            <h4 class="size-250 fl-space">hops	</h4>
    ...
    <div class="form-field clear"><br/>
        ...
        <span class="clean-padding bt-space20">
            ...
            <input id="bt1" name="btn3"  type="button" class="button green" value="Traceroute" onclick="trace()"/>
        </span>
    </div>
    <div class="rule2"></div>
<div id="div1"></div>
