...
public class AddMailListServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
	  ...
	  constraints.setSearchScope(SearchControls.ONELEVEL_SCOPE);
	   String attrList[] = {"domainCurrentListNumber","domainAliasName"}; 
	      ...
	      System.out.println("<br><br><br>"+ck);
	       ...
	       while (ae.hasMoreElements()) {
	           ...
	           String str= vals.nextElement().toString();
	            if(id.equalsIgnoreCase("domainCurrentListNumber"))
	           {
	           clistno=str;
	           }
	       ...
	       //NoOfUser nof=new NoOfUser();
	         ...
	         base="ou=Groups,domainName="+domain+",o=domains,"+mbase;
	 ...
	 Hashtable env = new Hashtable();
		   ...
		   env.put(Context.SECURITY_CREDENTIALS, password);
		    ...
		    try {
		      ...
		      ctx = new InitialDirContext(env);
		        ...
		        String entryDN ="mail="+mail+","+base;///"uid=amit,ou=Users,dc=silvereye,dc=in";
		            ...
		            entry.put( new BasicAttribute( "accessPolicy","public" ) ); 
		          // Add the entry
		    ...
		    ModifyDomainAtt.modyfyAtt(hs, domain, "domainCurrentListNumber", clistno);
		     
		     
		    } catch (NamingException e) {
		        System.out.println("AddUser: error adding entry." + e);
		        response.sendRedirect("/unifiedmail/global/addmaillist.jsp?status=error");
		    ...
		    base="ou=Externals,domainName="+domain+",o=domains,"+mbase;
				   ...
				   env.put(Context.SECURITY_CREDENTIALS, password);
				    ...
				    try {
				      ...
				      ctx = new InitialDirContext(env);
				        ...
				        String entryDN ="memberOfGroup="+mail+","+base;///"uid=amit,ou=Users,dc=silvereye,dc=in";
				            
				            Attribute oc = new BasicAttribute("objectClass");  
				            oc.add("mailExternalUser");
				            oc.add("top");
				            ...
				            entry.put( new BasicAttribute("memberOfGroup", mail ) );
				       ...
				       String data=ip+","+adm+","+domain+",Add List : "+mail;
				    ...
				    response.sendRedirect("/unifiedmail/global/addmaillist.jsp?status=succ&nm="+mail);  
				    } catch (NamingException e) {
				    	System.out.println("AddUser: error adding entry." + e);
				        response.sendRedirect("/unifiedmail/global/addmaillist.jsp?status=error");
