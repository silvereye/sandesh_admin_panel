...
public class DeleteWBlistUserServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public DeleteWBlistUserServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String sql="DELETE from userpref where username=? and prefid=?";
        ...
        int flg=0;
          ...
          while(rs.next())
			...
			res+="<span style=' margin-right: 4px; cursor: pointer;' name='"+preid+"' onclick='"+func+"(this.name)'>";
		...
		HttpSession hs=request.getSession(false);
	        ...
	        String data=ip+","+adm+","+domain+",Edit White/Black List: "+mail;
